                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="{{ route('admin.subcategories.destroy', $subcategory) }}" method="POST" class="inline">
                                                ...
                                                <button type="submit" 
                                                        ...
                                                        onclick="return confirm('¿Estás seguro de eliminar esta subcategoría? Esta acción no se puede deshacer.')">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-700">No hay subcategorías registradas</h3>
                                            <p class="mt-1 text-sm text-gray-500">Comienza creando una nueva subcategoría.</p>
                                            <div class="mt-6">
                                                <a href="{{ route('admin.subcategories.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        ...
                        <div class="mt-6 px-6 py-3 flex items-center justify-between border-t border-gray-200">
                            <div class="flex-1 flex justify-between sm:hidden">
                                @if ($subcategories->currentPage() > 1)
                                    <a href="{{ $subcategories->previousPageUrl() }}" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                        Anterior
                                    </a>
                                @else
                                ...
                                @if ($subcategories->hasMorePages())
                                    <a href="{{ $subcategories->nextPageUrl() }}" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                        Siguiente
                                    </a>
                                @else
