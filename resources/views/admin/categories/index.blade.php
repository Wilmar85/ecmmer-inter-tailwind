        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-700">No hay categorías registradas</h3>
                    ...
                    <!-- Paginación -->
                    @php
                        // Verificar si es una colección paginada o una colección regular
                        $isPaginated = method_exists($categories, 'links') && method_exists($categories, 'currentPage');
                        $hasItems = $categories->count() > 0;
                    @endphp
                    ...
                    @if($hasItems)
                        <div class="mt-6 px-6 py-3 flex items-center justify-between border-t border-gray-200">
                            ...
                            @else
                                <div class="flex-1">
                                    <p class="text-sm text-gray-700">
                                        Mostrando todos los <span class="font-medium">{{ $categories->count() }}</span> resultados
                                    </p>
                                </div>
                            @endif
                        </div>
