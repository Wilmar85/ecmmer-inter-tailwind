<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Sliders</h3>
                        <p class="text-gray-600 mb-4">Gestiona los sliders de la página de inicio.</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Tickets de Soporte</h3>
                        <p class="text-gray-600 mb-4">Gestiona las solicitudes de soporte de los clientes.</p>
    ...
    <div class="p-6">
        ...
        <!-- Sección de Tickets de Soporte Recientes -->
        <div x-data="{ open: true }" class="mt-12 max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold flex items-center gap-2">
                    <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
                    </svg>
                    <span>Tickets de Soporte Recientes</span>
                </h2>
                <a href="{{ route('support.tickets.index') }}" class="text-sm font-medium text-blue-600 hover:text-blue-800">
